...
### ASISTENCIA
Este es una mejora al módulo ya existente del módulo Registro de Movimientos y Asistencia de Planilla, ya que el sistema de plantillas deberá, en un futuro, este módulo deberá permitir gestionar permisos, licencias y vacaciones de los empleados, además de poder registrar la asistencia, horas extras, horas no trabajadas, feriados laborados y ausencias de los empleados. También se podrá contar con un calendario, que permita visualizar las fechas de vacaciones, licencias, ausencias y permisos de los empleados, de manera que facilite la coordinación en la empresa.
### DOCUMENTOS
